...
<body>
    ...
    <div class="container shadow">
        ...
        <form action="{{ route('simpan.hasil.perhitungan') }}" method="POST">
            @csrf
            <!-- Isi formulir -->
            <div class="result-form">
                ...
                <div class="hasil-perhitungan">
                    <ul>
                        @foreach($hasilData as $calculationKey2 => $calculationValue2)
                        <input type="hidden" name="hasilData[{{ $calculationKey2 }}]" value="{{ $calculationValue2 }}">
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="hasil-perhitungan">
                    <ul>
                        @foreach($hasilPerhitungan as $calculationKey => $calculationValue)
                        <input type="hidden" name="hasilPerhitungan[{{ $calculationKey }}]"
                ...
                <div class="hasil-perhitungan">
                    <ul>
                        @foreach($totalHarta as $calculationKey => $calculationValue)
                        <input type="hidden" name="totalHarta[{{ $calculationKey }}]" value="{{ $calculationValue }}">
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="button">
                    ...
                    <a button class="newhitung-button" href="/indexcal1" style="text-decoration : none;">NEW DATA <svg
